...
export const getDecoratedBrowserOptions = (defaults: any): any => {
  return decorateObject(defaults, "decorateBrowserOptions")
}

export const decorateWindowClass = (defaults: any): any => {
  return decorateObject(defaults, "decorateWindowClass")
}

export const decorateSessionOptions = (defaults: any): any => {
  return decorateObject(defaults, "decorateSessionOptions")
}

export const decorateSessionClass = (Session: any): any => {
